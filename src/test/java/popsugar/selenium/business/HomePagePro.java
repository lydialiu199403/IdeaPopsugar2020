...
public class HomePagePro {
   ...
   /* public void assertLogin(String expectedUrl) throws IOException, InterruptedException {
    ...
    public String getLoggedProfileUrl() throws IOException, InterruptedException {
        homePageH.clickHamMenuElement();
        Thread.sleep(3000);
        homePageH.clickProfileMenuElement();
        String currentUrl = homePageH.getCurrentURL();
    ...
    public String getLoggedProfileUsername() throws IOException, InterruptedException {
        homePageH.clickHamMenuElement();
        Thread.sleep(3000);
        homePageH.clickProfileMenuElement();
//        String currentCMSPageUsername = homePageH.getCMSPageUsername();
        String currentProfilePageUsername = homePageH.getProfilePageUsername();
        return currentProfilePageUsername;
    }
}
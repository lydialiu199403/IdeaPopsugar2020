...
public class CreateGalleryPage extends BasePage{
	...
	public String filename = "src/test/resources/CreateGalleryElement.properties";
	...
	public WebElement getCreateGalleryElement() throws IOException{
		return getElement(getByLocator.getLocator(filename, "CreateGallery"));
	}
	...
	public WebElement getTitleElement() throws IOException {
		return getElement(getByLocator.getLocator(filename,"Title"));
	}
	...
	public WebElement getMainSlideTextElement() throws IOException {
		return getElement(getByLocator.getLocator(filename,"MainSlideText"));
	}
